package com.controlclientes.demo.controlador;
...
import com.controlclientes.demo.servicio.EmpleadoService;
import com.controlclientes.demo.util.paginacion.PageRender;
import com.controlclientes.demo.util.reportes.EmpleadoExporterExcel;
import com.controlclientes.demo.util.reportes.EmpleadoExporterPDF;
...
public class EmpleadoController {
    ...
    public String guardarEmpleado(@Valid Empleado empleado,BindingResult result,Model modelo,RedirectAttributes flash,SessionStatus status){
      ...
      String mensaje = (empleado.getFecha() != null) ? "El empleado ha sido editado con exito" : "El empleado registrado con exito";
